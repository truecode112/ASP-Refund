...
<form name="refund" method="post"  onsubmit="return (Validator(this));" action="addprocess.asp" >
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="3"><span class="style3">Add New Refund </span></td>
        </tr>
        <tr>
          <td colspan="3">&nbsp;</td>
        </tr>
        <tr>
          <td width="25%"><span class="style8">Name</span></td>
        ...
        <tr>
          ...
          <td><strong>:</strong></td>
          <td><input type="text" name="customerrep" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
